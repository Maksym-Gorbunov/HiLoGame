...
<b-col sm="1" md="3" lg="4" align-self="center">
   <b-form-textarea v-if="this.$store.getters.getBot1.active" v-bind:class="{active:this.$store.getters.getBot1.active}" id="textarea-no-resize" placeholder="Fixed height textarea" rows="3" no-resize>
    </b-form-textarea>
